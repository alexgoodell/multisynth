...
#define SAMPLES_PER_MSEC AudioSynthWavetable::SAMPLES_PER_MSEC
#define UNITY_GAIN AudioSynthWavetable::UNITY_GAIN
#define LFO_PERIOD AudioSynthWavetable::LFO_PERIOD
